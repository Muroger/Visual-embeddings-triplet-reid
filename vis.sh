...
python src/vis.py --img_folder ../../dataset/ \
	...
	--query_h5 ./embed/myexperiment_3/in_shop_defense_triplet_loss_format_QUERY-model_10000.h5 \
	--gallery_csv ../../dataset/in_shop_defense_triplet_loss_format_GALLERY.csv \
	--gallery_h5 ./embed/myexperiment_3/in_shop_defense_triplet_loss_format_GALLERY-model_10000.h5 \
	--k 5 \
